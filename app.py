...
Original file is located at
    https://colab.research.google.com/drive/1lbYvIRs3q4e3Ryrcb-nhJm49yG2vdl90
...
st.title("🏥 Smart Hospital by Dr. Alex")
...
with col2:
  ...
  nausea_vomitting = 1 if st.checkbox("Nausea / Vomiting") else 0
  ...
  hypertension = 1 if st.checkbox("Hypertension or High Blood Pressure") else 0
...
if st.button("🚀 Process Patient Triage", type="primary", use_container_width=True):
  ...
  hr_encoded = {'Belom 60 bpm' : 0, '60-100 bpm' : 1, 'Above 100 bpm' : 2, 'Unknown': 3}[heart_rate_level]
  ...
  new_patient = pd.DataFrame([{
      ...
      'nausea_vomitting' : nausea_vomitting, 'dizziness' : dizziness, 'skin_rash' : skin_rash,
